...
const PAGE_META = {
  ...
  sdq: {title:'แบบประเมิน SDQ (ฉบับครูประเมิน)', sub:'ประเมินพฤติกรรมนักเรียน คิดคะแนน 5 ด้าน แปลผลจัดกลุ่ม พร้อม Dashboard สรุปผล'},
};
...
function showPage(p,btn){
  ...
  else if(p==='sdq'){ if(typeof renderSdqPage==='function') renderSdqPage(); }
}
