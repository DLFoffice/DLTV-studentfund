...
function _ensureStatusStyles() {
  ...
  st.textContent = `
    ...
    .status-pop{pointer-events:auto;cursor:pointer;display:flex;flex-direction:column;align-items:center;gap:14px;
      ...
      font-family:Noto Sans Thai,sans-serif;background:#fff;color:#1A1D2E;
...
function showLoading(show, msg = '') {
  ...
  if (!ov) {
    ...
    ov.innerHTML = '<div style="background:#fff;border-radius:14px;padding:28px 36px;text-align:center;font-family:Noto Sans Thai,sans-serif;box-shadow:0 8px 32px rgba(0,0,0,0.15)"><div style="font-size:32px;margin-bottom:10px">⏳</div><div id="loading-msg" style="font-size:14px;color:#1C1B18;font-weight:600"></div></div>';
