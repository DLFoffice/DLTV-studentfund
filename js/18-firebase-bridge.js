...
(function () {
  ...
  function applyCloudStudents(students) {
    ...
    if (typeof renderSdqPage === 'function' && document.getElementById('page-sdq')?.classList.contains('active') && typeof window.sdqOnDataUpdate === 'function') window.sdqOnDataUpdate();
  }
