  ...
  auth.onAuthStateChanged(async user => {
    ...
    try {
      if (studentMode) {
        ...
        if (typeof setSyncDot === 'function') setSyncDot('online');
        if (!d.exists)
          showTopBanner('⚠️ ไม่พบข้อมูลของคุณในระบบ (การเชื่อมบัญชีกับทะเบียนอาจไม่ตรง) — '
            + 'แจ้งครูผู้ดูแลให้เปิดหน้า "จัดการบัญชีผู้ใช้" แล้วกดปุ่ม "🔧 ซ่อมการเชื่อม" ของบัญชีคุณ');
